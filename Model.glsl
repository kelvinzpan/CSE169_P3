...
uniform vec3 LightDirection=normalize(vec3(7,7,-3));
uniform vec3 LightColor=vec3(1,0.2,1);
uniform vec3 LightDirection2=normalize(vec3(-3,-3,0));
uniform vec3 LightColor2=vec3(1,0.2,0.2);
